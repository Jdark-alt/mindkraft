        ...
        async function buildLevelUpCard(newLevel) {
            ...
            const xpLblW = (() => { ctx.font=sf(500,11); return ctx.measureText(xpLbl).width; })();
            const midX   = W/2;
            ...
            ctx.textAlign = 'center';
            ctx.fillText(xpLbl, midX, xpRowY);
            ...
            if (topActs.length > 0) {
                ...
                if (ta.streak>0) {
                    ctx.font='13px serif'; ctx.fillStyle=uOlv;
            ...
            if (top2.length > 0) {
                ...
                top2.forEach((cat,i)=>{
                    ...
                    ctx.fillText(cat.label, cx+38, cy+28);
                    ctx.font=sf(400,11); ctx.fillStyle='rgba(255,255,255,0.38)';
                    ctx.fillText(cat.xp.toLocaleString()+' XP', cx+38, cy+46);
                });
                curY += cH2 + 12;
            }
