        ...
        async function buildLevelUpCard(newLevel) {
            ...
            ctx.font = `800 ${numFS}px system-ui, -apple-system, sans-serif`;
            ...
            function statCard(x, y, w, h, label, val, sub, ac) {
                ...
                ctx.font = `700 ${val.length > 8 ? 42 : 52}px system-ui, sans-serif`;
            ...
            if (top2.length > 0) {
                ...
                top2.forEach((cat, i) => {
                    ...
                    ctx.font = '500 52px system-ui, sans-serif'; ctx.textAlign = 'left';
                    ctx.fillText(cat.emoji, cx + 20, cy + 72);
                    ctx.font = '600 32px system-ui, sans-serif'; ctx.fillStyle = cat.color;
                    ctx.fillText(cat.label, cx + 88, cy + 64);
                    ctx.font = '400 24px system-ui, sans-serif'; ctx.fillStyle = 'rgba(255,255,255,0.38)';
            ...
            if (bestStreak && bestStreak.streak >= 3) {
                ...
                if (strY + strH < FOOTER_TOP - 20) {
                    ...
                    ctx.font = '700 38px system-ui, sans-serif'; ctx.fillStyle = uOlive;
