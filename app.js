        ...
        function updateDashboard() {
            ...
            // Mirror the level into the SVG trace overlay so the golden
            // stroke animation draws the actual current digit shape.
            var _traceEl = document.getElementById('currentLevelTrace');
            if (_traceEl) _traceEl.textContent = level;
