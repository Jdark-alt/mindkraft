        ...
        const THEMES = [
            ...
            // ── Light themes (v109) ───────────────────────────────────────────
            { id:'paper',    name:'Paper',     mode:'light', bg:'#f4f1ea', card:'#ffffff', accent:'#3b6fb0', progress:'#2e8bc0' },
            { id:'sunrise',  name:'Sunrise',   mode:'light', bg:'#fdf3ec', card:'#ffffff', accent:'#d96644', progress:'#e07a3e' },
            { id:'mint',     name:'Mint',      mode:'light', bg:'#eef6f0', card:'#ffffff', accent:'#2e7d6b', progress:'#3a9b80' },
            { id:'lavender', name:'Lavender',  mode:'light', bg:'#f4f0f9', card:'#ffffff', accent:'#7b5fb5', progress:'#9b7bd4' },
        ];
