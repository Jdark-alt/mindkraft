        ...
        function showLevelUpAnimation() {
            ...
            if (reward || newLevel === 100) {
                ...
                // Level text — trophy serif treatment for the celebration moment.
                const levelText = document.createElement('span');
                levelText.style.cssText = "font-family:var(--font-display);font-weight:400;font-size:clamp(28px,9vw,48px);letter-spacing:-0.025em;font-variant-numeric:tabular-nums;line-height:1.05;";
