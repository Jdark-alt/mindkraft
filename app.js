        ...
        // Ring is positioned absolutely at the bottom-left of the card via CSS.
        ...
        function _gcRing(completedToday, currentStreak, dimHex, xpText, type) {
            // 20% smaller than before. Type 3 (2×1) was 34, now 27. Others were 44, now 35.
            var isCompact = (type === 3);
            var size = isCompact ? 27 : 35;
            var r    = isCompact ? 11 : 14;
            var sw   = isCompact ? 2.2 : 2.6;
        ...
        function renderActivityGridCards(activities) {
            ...
            function renderCard(activity) {
                ...
                if (type === 2) {
                    ...
                    // Type 7 (3×1): list-style — name on left, XP/streak/badges on right
                    bodyContent = '<div class="gc-row7">'
                        + '<div class="gc-name">' + escapeHtml(activity.name) + '</div>'
                        + '<div class="gc-row7-right">'
