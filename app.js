        ...
        function isCompletedToday(activity) {
            ...
            if (activity.frequency === 'daily') {
                ...
                // Reset every Sunday (calendar week boundary)
                ...
                return new Date(activity.lastCompleted) >= weekStart;
                ...
                return new Date(activity.lastCompleted) >= cycleStart;
                ...
                return new Date(activity.lastCompleted) >= monthStart;
            }
            return false;
        }
        ...
        var VAPID_PUBLIC_KEY = 'BAceGWs6xfm31JCGcNPsP8a7unWEMlhPQoe7lI0X3SOEpSgXeI0kNN9em7ta0BMQZ2aFK9-q8nZXz07BVYBWZDc';
