        ...
        function renderActivityCards(activities) {
            ...
            return activities.map(activity => {
                ...
                const atRiskChip = atRisk
                    ? `<span class="card-atrisk" aria-label="Streak at risk"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M10.3 3.86 1.82 18a2 2 0 0 0 1.7 3h16.96a2 2 0 0 0 1.7-3L13.7 3.86a2 2 0 0 0-3.4 0Z"/><line x1="12" y1="9" x2="12" y2="13"/><circle cx="12" cy="17" r="1" fill="currentColor"/></svg></span>`
                    : '';
                    ...
                    <div class="activity-info-container">
                        <div class="activity-row-main">
                            ...
                            <div class="activity-row-right">
                                <!-- Progress ring — shifts left visually when card is completed
                                     because the undo button claims the rightmost slot. -->
