        ...
        function updateDashboard() {
            ...
            // Without this, the SVG keeps its initial width and the right
            // edge gets clipped at 3+ digits OR leaves dead space at 1-2.
            (function syncLevelSvgWidth() {
                ...
                // Measure on the next animation frame so the font has
                // committed metrics. getComputedTextLength returns the
                // rendered length in SVG user units (= CSS pixels when
                // no viewBox is set).
                requestAnimationFrame(function() {
                    ...
                    } catch (e) { /* getBBox/getComputedTextLength can fail
                                     pre-layout — harmless, retried on next
                                     dashboard tick. */ }
                });
            })();
