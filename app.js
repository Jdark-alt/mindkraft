        ...
        function renderCalendar() {
            ...
            for (let d = 1; d <= daysInMonth; d++) {
                ...
                // Determine which column this day lands on (0=Sun … 6=Sat)
                const col = (firstDow + d - 1) % 7; // 0-indexed day-of-week column
                const tipSide = col >= 5 ? 'left' : 'right'; // last 2 cols → tip opens left
