        ...
        window.saveGroupFromModal = async function(event) {
            ...
            if (editingId) {
                ...
                // Reconcile only THIS group's membership: previous members
                // that got de-selected leave this group; selected ids join.
                // Multi-group activities are not stripped from other groups
                // by setGroupMembership — single-group ones still are.
