        ...
        // ── Generic analytics section collapse toggle ─────────────────
        ...
        function renderAnalyticsSummary(activities, log) {
            ...
            // XP today — sum completions from today only in the scope-filtered log
            const todayStr = localToday();
            ...
            // Highest live streak across scope activities (current, not historic best)
            const highestStreak = activities.reduce((s, a) => Math.max(s, a.streak || 0), 0);

            // SVG icons for each stat (stroke-based, theme-consistent)
            const icons = {
                xp:         `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>`,
                done:       `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>`,
                today:      `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>`,
                week:       `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>`,
                rate:       `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>`,
                streak:     `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z"/></svg>`,
            };

            const rows = [
                [
                    { v: totalXP.toLocaleString(),          l: 'Total XP Earned',   icon: icons.xp,     accent: 'green'  },
                    { v: totalCompletions.toLocaleString(), l: 'Total Completions',  icon: icons.done,   accent: 'blue'   },
                ],
                [
                    { v: xpToday.toLocaleString(),          l: 'XP Today',           icon: icons.today,  accent: 'green'  },
                    { v: weeklyXP.toLocaleString(),         l: 'XP This Week',       icon: icons.week,   accent: 'green'  },
                ],
                [
                    { v: xpPerHour.toLocaleString(),        l: 'XP / Hour',          icon: icons.rate,   accent: 'amber'  },
                    { v: highestStreak,                     l: 'Highest Streak',     icon: icons.streak, accent: 'coral'  },
                ],
            ];
