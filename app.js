        ...
        window.openGridActionMenu = function(activityId) {
            ...
            el.innerHTML =
                '<div class="gc-action-menu-inner" onclick="event.stopPropagation()">'
                + '<button class="gc-action-item" onclick="event.stopPropagation();closeGridActionMenu();setTimeout(function(){openCardTypePicker(\'' + activityId + '\');},60);">'
                + '<span class="gc-action-icon">⊞</span><span>Change card size</span></button>'
                + '<button class="gc-action-item" onclick="event.stopPropagation();closeGridActionMenu();setTimeout(function(){openGridCardOverlay(\'' + activityId + '\');},60);">'
                + '<span class="gc-action-icon">⋯</span><span>View details</span></button>'
                + '<button class="gc-action-item gc-action-cancel" onclick="event.stopPropagation();closeGridActionMenu();">Cancel</button>'
                + '</div>';
