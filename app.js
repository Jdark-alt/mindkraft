        ...
        function recomputeStreakFromHistory(activity) {
            ...
            if (streakStartFloor) {
                // ── Forward walk (same algorithm as processStreakSystem) ──────
                ...
                for (let i = 0; i < MAX_WALK; i++) {
                    ...
                    if (hit) {
                        streak++;
                        streakStartWindow = streakStartWindow || fwdCursor;
            ...
            // BUG FIX: if the closed-window walk broke (streak=0) but the user
            // completed today, this is a FRESH 1-day streak — don't carry the
            // broken walk's shieldsConsumed (would show "0 shields left" on day 1).
            if (hasTodayCompletion) {
                if (streak === 0) { shieldsConsumed = 0; walkCapUsed = BASE_SHIELDS; }
                streak++;
            }
