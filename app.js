        ...
        window.openGridActionMenu = function(activityId) {
            ...
            el.innerHTML =
                ...
                + '<button class="gc-action-item" onclick="openCardTypePicker(\'' + activityId + '\');closeGridActionMenu();">'
                + '<span class="gc-action-icon">⊞</span><span>Change card size</span></button>'
                + '<button class="gc-action-item" onclick="openGridCardOverlay(\'' + activityId + '\');closeGridActionMenu();">'
                + '<span class="gc-action-icon">⋯</span><span>View details</span></button>'
                + '<button class="gc-action-item gc-action-cancel" onclick="closeGridActionMenu()">Cancel</button>'
                + '</div>';
